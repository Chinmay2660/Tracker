...
export const createInterview = async (req: AuthRequest, res: Response) => {
    try {
        ...
        const populated = await InterviewRound.findById(interview._id).populate('hrContactId', 'companyName intermediaryCompanyName hrName phone email companyType noticePeriodLwdNote');
...
export const updateInterview = async (req: AuthRequest, res: Response) => {
    try {
        ...
        const updatedInterview = await InterviewRound.findByIdAndUpdate(id, mongoUpdate, { new: true }).populate('hrContactId', 'companyName intermediaryCompanyName hrName phone email companyType noticePeriodLwdNote');
