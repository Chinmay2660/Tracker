...
export default function ResumeManagerPage() {
    ...
    return (<div className="space-y-4 sm:space-y-6">
      ...
      {resumes.length === 0 ? (<Card className="border-dashed">
          <CardContent className="py-16 sm:py-20 text-center">
            ...
            <Button onClick={() => fileInputRef.current?.click()} variant="outline" size="lg" className="px-6">
              <Upload className="h-5 w-5 mr-2"/>
              Upload Resume
            </Button>
          </CardContent>
        </Card>) : (<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {resumes.map((resume) => (<Card key={resume._id} className="hover:shadow-md transition-shadow">
