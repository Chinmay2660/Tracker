...
export default function OfflinePage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="relative z-10 text-center space-y-8 max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Button onClick={handleRetry} disabled={isRetrying} className="gap-2 px-6 py-5 text-base bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 border-0 shadow-lg shadow-emerald-500/25 dark:shadow-emerald-500/15 transition-all duration-300 hover:scale-105">
