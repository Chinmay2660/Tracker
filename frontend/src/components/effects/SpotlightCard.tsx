...
function SpotlightCard({ children, className, spotlightColor = 'rgba(45, 180, 160, 0.15)' }: SpotlightCardProps) {
    ...
    return (<div ref={divRef} className={cn('relative overflow-hidden', className)} onMouseMove={handleMouseMove} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
