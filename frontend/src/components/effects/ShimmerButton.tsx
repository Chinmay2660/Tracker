...
function ShimmerButton({ children, className, shimmerColor = 'rgba(255, 255, 255, 0.3)', ...props }: ShimmerButtonProps) {
    return (<button className={cn('relative inline-flex items-center justify-center overflow-hidden rounded-full font-medium transition-all', 'bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600', 'text-white shadow-lg shadow-teal-500/25 hover:shadow-xl hover:shadow-teal-500/30', 'hover:scale-[1.02] active:scale-[0.98]', className)} {...props}>
