...
function InteractiveBackground({ className = '', dotColor = 'rgba(45, 180, 160, 0.5)', lineColor = 'rgba(45, 180, 160, 0.15)', particleCount = 80 }: InteractiveBackgroundProps) {
    ...
    return (<canvas ref={canvasRef} className={`fixed inset-0 pointer-events-none ${className}`} style={{ opacity: 0.7 }}/>);
}
