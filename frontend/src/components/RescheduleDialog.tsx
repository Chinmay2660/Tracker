...
export default function RescheduleDialog({ open, onOpenChange, interview, job, onSuccess, }: RescheduleDialogProps) {
    ...
    return (<Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent onClose={handleClose} className="max-w-sm">
        ...
        {interview && (<div className="space-y-4 mt-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="reschedule-date" type="date" value={rescheduleDate} onChange={(e) => setRescheduleDate(e.target.value)} min={format(new Date(), 'yyyy-MM-dd')}/>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input id="reschedule-end-time" type="time" value={rescheduleEndTime} onChange={(e) => setRescheduleEndTime(e.target.value)}/>
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-2">
              ...
              <Button onClick={handleReschedule} disabled={!rescheduleDate || isRescheduling} className="flex-1 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white">
