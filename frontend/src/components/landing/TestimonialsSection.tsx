...
function TestimonialsSection() {
    return (<section className="py-12 sm:py-20 overflow-hidden bg-slate-50/50 dark:bg-slate-900/30">
      ...
      <TestimonialCarousel testimonials={testimonials} speed={25} pauseOnHover={true}/>
    </section>);
}
