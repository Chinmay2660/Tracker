    ...
    return (<section className="py-10 sm:py-16 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {steps.map((item, i) => (<div key={i} className="scroll-reveal relative group">
              ...
              {i < 2 && (<div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-20">
