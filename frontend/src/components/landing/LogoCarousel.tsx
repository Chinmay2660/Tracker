...
function LogoCarousel() {
    return (<section className="py-6 border-y border-slate-200/50 dark:border-slate-800/50 bg-slate-50/50 dark:bg-slate-900/30 overflow-hidden">
      ...
      <Marquee speed={40} className="py-1">
        {logos.map((logo, i) => (<div key={i} className="flex items-center justify-center px-6 sm:px-10">
