...
function HeroSection() {
    ...
    return (<section className="relative pt-28 sm:pt-32 pb-12 sm:pb-16 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="scroll-reveal-scale hidden sm:block">
            ...
            { name: 'Offer', count: 2, color: 'bg-emerald-500' },
        ].map((col, i) => (<div key={i} className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-3">
                        ...
                        <div className="space-y-1.5">
                          {[1, 2].map(j => (<div key={j} className="bg-white dark:bg-slate-900 rounded p-2 border border-slate-100 dark:border-slate-700">
