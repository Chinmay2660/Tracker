...
function DashboardSkeleton() {
    return (<div className="min-h-screen bg-slate-50 dark:bg-slate-950" style={{ padding: '1rem' }}>
      
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800" style={{
            height: '4rem',
            marginBottom: '1.5rem',
            marginLeft: '-1rem',
            marginRight: '-1rem',
      ...
      <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '1rem' }}>
          {[1, 2, 3, 4].map((i) => (<div key={i} className="bg-slate-100 dark:bg-slate-900/50" style={{ borderRadius: '0.75rem', padding: '1rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {[1, 2, 3].map((j) => (<div key={j} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700" style={{ borderRadius: '0.5rem', padding: '0.75rem' }}>
